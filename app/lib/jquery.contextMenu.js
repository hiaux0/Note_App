                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (item.type && types[item.type]) {
                        ...
                        switch (item.type) {
                            ...
                            // ---------------------------------------------
                            // TODO: i was here #here #hereee
                            case 'number':
                                $input = $('<input type="number" value="1" name="" />')
                                    .attr('name', 'context-menu-input-' + key)
                                    .val(item.value || '')
                                    // .prop('checked', !!item.selected)
                                    .prependTo($label);
                            ...
                            case 'range':
                                ...
                                $('<span id="sliderOutput"></span>').appendTo($label).html(` ${item.value}`);
                                $input = $('<input type="range" name="" />')
                                    .attr('name', 'context-menu-input-' + key).val(item.value || '').attr('id',`${item.id}`)
                                    .appendTo($label);
