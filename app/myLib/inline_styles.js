 ...
 */
    method.inlineStyle = function(obj) {
        let tempString = '';
 ...
 */
    method.addInlineStyle = function(selector,obj) {
        return selector.setAttribute('style',method.inlineStyle(obj))
    }
 ...
 */
    method.toStylesheet = function(obj) {
        let tempString = ''
        for (let selector of Object.keys(obj)) {
            ...
            for (let costumName of Object.keys(obj[selector])) {
                ...
                // console.log(method.inlineStyle(obj[selector][costumName]));
                tempString += method.inlineStyle(obj[selector][costumName])
                tempString += "} "    }}
        return tempString;
    }
    /**
     ...
     */
    method.changeStyle = function(node,obj) {
        let resultString = '';
    ...
    let teststring = 'hallo du'
    let changeString = 'du'
    teststring.includes(changeString)
    teststring.indexOf(changeString)
